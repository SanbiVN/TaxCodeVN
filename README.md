...
[ptUserAddin]: https://github.com/SanbiVN/TaxCodeVN/releases/download/v4.30/TaxCode_v4.30.zip
[ptUserWebview2]: https://go.microsoft.com/fwlink/p/?LinkId=2124703

|  Thông tin   | Tải xuống | Lượt tải |
|--------------|-----------|----------|
| TaxCode Add-in Excel | [TaxCode_v4.30.zip][ptUserAddin] | [![Lượt tải](https://img.shields.io/github/downloads/SanbiVN/TaxCodeVN/total.svg)](https://github.com/SanbiVN/TaxCodeVN/releases/download/v4.30/TaxCode_v4.30.zip)  |
